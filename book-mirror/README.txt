...
Nothing else belongs in this directory. Adding a fifth file means re-opening the
...
--------------------------------------------------------------------------------
  ...
  1. Copy the new scripts/lilypond-book.py, python/book_snippets.py,
     python/book_base.py and python/book_texinfo.py over the four files here.
