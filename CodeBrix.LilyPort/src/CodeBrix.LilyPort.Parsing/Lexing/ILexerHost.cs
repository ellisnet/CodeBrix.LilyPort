...
/// not have to depend on whatever eventually plays the part of <c>Lily_parser</c>.
/// //was previously: this sentence named <c>Context.ContextFactory</c> in the Engine as
/// the same seam for the same reason; that seam is retired and the member no longer
/// exists.
/// </para>
/// </summary>
