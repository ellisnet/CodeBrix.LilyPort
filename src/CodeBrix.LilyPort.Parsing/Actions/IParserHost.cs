...
/// the actions stay faithful to the upstream bodies while
/// <c>CodeBrix.LilyPort.Parsing</c> does not depend on the Scheme interpreter's
/// lifecycle. //was previously: this sentence also cited the Engine's
/// <c>Context.ContextFactory</c> as the third instance of the pattern; that seam is
/// retired and the member no longer exists. The REAL host is whatever eventually plays
