...
/// carry. This is where <c>Context_def</c> comes from — the definitions the engine's
/// <c>ContextDef</c> carries and <c>Context</c> reads back out.
/// //was previously: "the definitions the engine's interim
/// <c>Context.ContextFactory</c> seam stands in for"; that seam is retired and the
