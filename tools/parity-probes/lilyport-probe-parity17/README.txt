...
They live in ~/GitHome/CodeBrix.LilyPort/tools/parity-probes/lilyport-probe-parity16
and PARITY 17 used drift.py on all 53 PLACEMENT-DIFFERS rows at once, which took
one run and re-ranked the whole residue.  Trap 7a earned its place a fourth time:
