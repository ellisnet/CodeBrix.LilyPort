...
from the Metafont sources in mf/, on a clean Debian-based
...
The full record is in THIRD-PARTY-NOTICES.txt. The operative
points for anyone running this build:

  THE FONT SOURCES ARE DUAL-LICENSED. Everything under mf/ is
...
================================================================================
  ...
  Everything else the build needs is in mf/, which is a
